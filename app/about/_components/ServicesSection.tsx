...
import { ServiceItemProps, StatCounterProps } from "./types";
...
export const ServicesSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full py-24 px-4 bg-gradient-to-b from-muted/30 to-background text-foreground overflow-hidden relative"
    >
      <motion.div
